"""Seed built-in NEP-Data project entries."""

from .database import Database
from .services import ModelService, ProjectService


def seed_nep_data_git(db: Database, project_service: ProjectService, model_service: ModelService) -> None:
    if not db.first:
        return
    project = project_service.create_project("NEP-Data","NEP官方的公开数据集,地址：https://gitlab.com/brucefan1983/nep-data")
