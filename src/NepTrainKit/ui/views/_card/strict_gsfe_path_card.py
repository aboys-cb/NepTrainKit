...
class StrictGSFEPathCard(MakeDataCard):
    ...
    def __init__(self, parent=None):
        ...
        self.setTitle("Make Strict GSFE Path")
        self.init_ui()
    ...
    def init_ui(self):
        ...
        self.uvw_label = BodyLabel("u v w", self.setting_widget)
        self.uvw_frame = SpinBoxUnitInputFrame(self)
        self.uvw_frame.set_input("", 3, "int")
        self.uvw_frame.setRange(-10, 10)
        self.uvw_frame.set_input_value([1, 1, -2])
        self.uvw_label.setToolTip("Slip direction. It is projected into the selected plane.")
        self.uvw_label.installEventFilter(ToolTipFilter(self.uvw_label, 300, ToolTipPosition.TOP))

        self.disp_label = BodyLabel("Displacement", self.setting_widget)
        ...
        self.unit_label = BodyLabel("Unit", self.setting_widget)
        self.unit_combo = ComboBox(self.setting_widget)
        self.unit_combo.addItems(["fraction_of_vector", "angstrom"])

        self.cut_label = BodyLabel("Cut", self.setting_widget)
        self.cut_combo = ComboBox(self.setting_widget)
        self.cut_combo.addItems(["middle", "fractional", "layer_index"])

        self.cut_fraction_label = BodyLabel("Cut fraction", self.setting_widget)
        ...
        self.layer_label = BodyLabel("Layer index", self.setting_widget)
        ...
        self.wrap_checkbox = CheckBox("Wrap", self.setting_widget)
    ...
    def get_params(self) -> StrictGSFEPathParams:
        return StrictGSFEPathParams(
            ...
            displacement_unit=self.unit_combo.currentText(),
            cut_mode=self.cut_combo.currentText(),
    ...
    def set_params(self, params: StrictGSFEPathParams) -> None:
        ...
        self.unit_combo.setCurrentText(params.displacement_unit)
        self.cut_combo.setCurrentText(params.cut_mode)
