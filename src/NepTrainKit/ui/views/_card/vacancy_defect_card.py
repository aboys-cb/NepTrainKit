...
class VacancyDefectCard(MakeDataCard):
    ...
    def __init__(self, parent=None):
        ...
        self.setTitle(self.tr("Make Vacancy Defect"))
        self.init_ui()
    ...
    def init_ui(self):
        ...
        self.num_radio_button = RadioButton(self.tr("Vacancy count"),self.setting_widget)
        self.num_radio_button.setChecked(True)
        self.num_radio_button.setToolTip(self.tr("Use atom count as the vacancy amount control"))
        ...
        self.concentration_radio_button = RadioButton(self.tr("Vacancy fraction"),self.setting_widget)
        self.concentration_radio_button.setToolTip(self.tr("Use fraction of atoms as the vacancy amount control"))
        ...
        self.count_mode_label.setToolTip(self.tr("Fixed removes exactly the requested amount. Random samples from 1 to that amount."))
        ...
        self.count_mode_combo.addItem(self.tr("Random up to value"), userData="random")
    ...
    def set_params(self, params: VacancyDefectParams) -> None:
        ...
        self.count_mode_combo.setCurrentIndex(0 if params.count_mode == "fixed" else 1)
