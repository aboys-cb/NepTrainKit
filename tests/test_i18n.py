...
_TASK5_TRANSLATIONS = {
    ...
    "StructureInfoWidget": {
        ...
        "Specific prototypes use separate geometry and species-ordering checks; a-CNA only reports FCC, HCP, and BCC local environments. A face-centered cubic Bravais lattice does not by itself make every site an FCC a-CNA environment.": "具体晶体原型使用独立的几何与物种有序检查；a-CNA 只报告 FCC、HCP 和 BCC 局域环境。面心立方布拉菲格子本身不代表每个原子位点都是 a-CNA 的 FCC 环境。",
        "Reference crystallography (ideal prototype): {pearson} · {space_group} (No. {number}) · {bravais}": "参考晶体学（理想原型）：{pearson} · {space_group}（No. {number}）· {bravais}",
        "Reference values describe the matched ideal prototype; the distorted snapshot may have lower instantaneous symmetry.": "参考值描述已匹配的理想原型；畸变后的当前快照可能具有更低的瞬时对称性。",
        "Face-centered cubic Bravais lattice": "面心立方布拉菲格子",
        "Body-centered cubic Bravais lattice": "体心立方布拉菲格子",
        "Primitive hexagonal Bravais lattice": "六方原始布拉菲格子",
        "Primitive cubic Bravais lattice; FCC-derived ordering": "简单立方布拉菲格子；FCC 衍生有序结构",
        "Primitive tetragonal Bravais lattice; FCC-derived ordering": "简单四方布拉菲格子；FCC 衍生有序结构",
        "Primitive cubic Bravais lattice; BCC-derived ordering": "简单立方布拉菲格子；BCC 衍生有序结构",
        "Face-centered cubic Bravais lattice; BCC-derived ordering": "面心立方布拉菲格子；BCC 衍生有序结构",
        "Diamond (A4)": "金刚石（A4）",
        "B1 (rock-salt)": "B1（岩盐）",
        "B3 (zinc blende)": "B3（闪锌矿）",
        "B4 (wurtzite)": "B4（纤锌矿）",
        "C1 (fluorite)": "C1（萤石）",
        "L2₁ (full-Heusler)": "L2₁（全赫斯勒）",
        "C1ᵦ (half-Heusler)": "C1ᵦ（半赫斯勒）",
    ...
    "TrainingSetAuditWidget": {
        ...
        "L2₁ (full-Heusler)": "L2₁（全赫斯勒）",
        "C1ᵦ (half-Heusler)": "C1ᵦ（半赫斯勒）",
        " Confirmed prototypes: {values}.": " 已确认原型：{values}。",
    },
    "Update": {
