...
SCENARIOS: dict[str, ScenarioSpec] = {
    ...
    "training_set_audit_overview": ScenarioSpec(
        ...
        description="Audit overview showing dataset facts, element co-occurrence, and exact element sets.",
        annotations=(
            Annotation("1", "确认数据概况", "widget:metric_band", "bottom-right"),
            Annotation("2", "查看元素共现", "widget:cooccurrence_panel", "right"),
            Annotation("3", "核对精确元素集合", "widget:element_sets_panel", "left"),
    ...
    "make_data_empty": ScenarioSpec(
        ...
        options={"context": "make_data"},
        annotations=(
            Annotation("1", "Workflow library", "widget:make_data_interface.workspace_card_widget.library_panel", "top-left"),
            ...
            Annotation("4", "Card inspector", "widget:make_data_interface.workspace_card_widget.guidance_panel", "top-left"),
        ),
    ),
    ...
    "make_data_card_system_controls": ScenarioSpec(
        ...
        annotations=(
            Annotation("1", "Enable or skip this card", "widget:card_workflow_supercell.state_checkbox", (430, 190)),
            Annotation("2", "Collapse or expand settings", "widget:card_workflow_supercell.collapse_button", (500, 190)),
            Annotation("3", "Open this card's manual", "widget:make_data_interface.workspace_card_widget.guidance_panel.docs_button", (1360, 14)),
            Annotation("4", "Show card provenance", "widget:make_data_interface.workspace_card_widget.guidance_panel.info_button", (1410, 14)),
            Annotation("5", "Copy this card as JSON", "widget:make_data_interface.workspace_card_widget.guidance_panel.copy_card_button", (1460, 14)),
            Annotation("6", "Remove this card", "widget:card_workflow_supercell.close_button", (900, 190)),
        ),
    ),
